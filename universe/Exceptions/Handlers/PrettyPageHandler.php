...
class PrettyPageHandler extends Handler
{
     ...
     * @var bool
     */
    private $handleUnconditionally = true;
    ...
    public function __construct()
    {
        ...
        $ReflectionClass = new \ReflectionClass( Run::class );


        // Add the default, local resource search path:
        $this->searchPaths[] = dirname($ReflectionClass->getFileName()) . "/Resources";
    ...
    public function handle()
    {
        ...
        $vars = [
            ...
            "tables"      => [
                ...
                "Cookies"               => $this->masked($request->request->cookie??[], '_COOKIE'),
                "Session"               => $this->masked($request->getSession()->all()??[], '_SESSION'),
